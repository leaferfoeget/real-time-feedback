...
#set_property BITSTREAM.GENERAL.COMPRESS True [current_desgn]
...
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks mmcm0_clk0] -group [get_clocks -include_generated_clocks sys_clk_p ]
#输出
set_property PACKAGE_PIN U3  [get_ports {dout[0]}]
set_property PACKAGE_PIN AB3 [get_ports {dout[1]}]
set_property PACKAGE_PIN AA1 [get_ports {dout[2]}]
set_property PACKAGE_PIN T1  [get_ports {dout[3]}]
set_property PACKAGE_PIN U2  [get_ports {dout[4]}]
set_property PACKAGE_PIN R3  [get_ports {dout[5]}]
set_property PACKAGE_PIN AA5 [get_ports {dout[6]}]
set_property PACKAGE_PIN U6  [get_ports {dout[7]}]
set_property PACKAGE_PIN R6  [get_ports {dout[8]}]
set_property PACKAGE_PIN Y8  [get_ports {dout[9]}]
set_property PACKAGE_PIN Y6  [get_ports {dout[10]}]
set_property PACKAGE_PIN AA8 [get_ports {dout[11]}]
set_property PACKAGE_PIN J5  [get_ports {dout[12]}]
set_property PACKAGE_PIN G1  [get_ports {dout[13]}]
set_property PACKAGE_PIN C2  [get_ports {dout[14]}]
set_property PACKAGE_PIN B1  [get_ports {dout[15]}]
set_property PACKAGE_PIN E2  [get_ports {dout[16]}]
set_property PACKAGE_PIN K1  [get_ports {dout[17]}]
set_property PACKAGE_PIN M1  [get_ports {dout[18]}]
#set_property PACKAGE_PIN M6  [get_ports {dout[19]}]
#set_property PACKAGE_PIN N4  [get_ports {dout[20]}]
#set_property PACKAGE_PIN P2  [get_ports {dout[21]}]
#set_property PACKAGE_PIN M3  [get_ports {dout[22]}]
#set_property PACKAGE_PIN K6  [get_ports {dout[23]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dout[*]}]

####XS17,XS18,XS19
##set_property IOSTANDARD LVCMOS33 [get_ports shot_rst]
##set_property PACKAGE_PIN K1 [get_ports shot_rst]
##set_property IOSTANDARD LVCMOS33 [get_ports k1]
##set_property PACKAGE_PIN M1 [get_ports k1]
set_property IOSTANDARD LVCMOS33 [get_ports photo_rst1]
set_property PACKAGE_PIN M6 [get_ports photo_rst1]

####XS20,XS21,XS22,XS23
set_property IOSTANDARD LVCMOS33 [get_ports stop_in1]
set_property PACKAGE_PIN N4 [get_ports stop_in1]
set_property IOSTANDARD LVCMOS33 [get_ports stop_singleshot]
set_property PACKAGE_PIN P2 [get_ports stop_singleshot]
set_property IOSTANDARD LVCMOS33 [get_ports start1]
set_property PACKAGE_PIN M3 [get_ports start1]
set_property IOSTANDARD LVCMOS33 [get_ports start_rst1]
set_property PACKAGE_PIN K6 [get_ports start_rst1]
